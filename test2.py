...
CREATE TABLE KafkaSource (
    ...
    'connector' = 'kafka',
    'topic' = 'MYNEWagrolabproject.MYNEWagrolabtopic',
...
CREATE TABLE KafkaSink (
    ...
    'connector' = 'kafka',
    'topic' = 'MYNEWagrolabproject.MYNEWagrolabtopic.10days.avg.precipitation',
    'properties.bootstrap.servers' = '155.207.19.243:19092',
    'format' = 'json'
)
""")
...
SELECT
    `key`,
    TUMBLE_START(`event_time`, INTERVAL '10' DAYS) as window_start,
    TUMBLE_END(`event_time`, INTERVAL '10' DAYS) as window_end,
    COUNT(*) as `count`,
    AVG(precipitation) as avg_precipitation
FROM KafkaSource
GROUP BY `key`, TUMBLE(`event_time`, INTERVAL '10' DAYS)
""")
