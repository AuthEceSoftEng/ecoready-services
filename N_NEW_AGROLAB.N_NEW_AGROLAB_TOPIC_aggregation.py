...
CREATE TABLE KafkaSink (
    ...
    'connector' = 'kafka',
    'topic' = 'N_NEW_AGROLAB.N_NEW_AGROLAB_TOPIC.2hours.avg.temperature',
    'properties.bootstrap.servers' = '155.207.19.243:19092',
    'format' = 'json'
)
""")
...
SELECT
    `key`,
    TUMBLE_START(`event_time`, INTERVAL '2' HOURS) as window_start,
    TUMBLE_END(`event_time`, INTERVAL '2' HOURS) as window_end,
    COUNT(*) as `count`,
    AVG(temperature) as avg_temperature
FROM KafkaSource
GROUP BY `key`, TUMBLE(`event_time`, INTERVAL '2' HOURS)
""")
