...
CREATE TABLE KafkaSink (
    ...
    'connector' = 'kafka',
    'topic' = 'n_new_agrolab.n_new_agrolab_topic.1hours.avg.temperature',
    'properties.bootstrap.servers' = '155.207.19.243:19092',
    'format' = 'json'
)
""")
...
SELECT
    `key`,
    TUMBLE_START(`event_time`, INTERVAL '1' HOURS) as window_start,
    TUMBLE_END(`event_time`, INTERVAL '1' HOURS) as window_end,
    COUNT(*) as `count`,
    AVG(temperature) as avg_temperature
FROM KafkaSource
GROUP BY `key`, TUMBLE(`event_time`, INTERVAL '1' HOURS)
""")
